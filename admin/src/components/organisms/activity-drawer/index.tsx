...
const EmptyActivityDrawer = () => {
    return (
        <div className="flex h-full w-full flex-col items-center justify-center p-4">
            ...
            <span
                className={'inter-base-regular mt-4 text-center text-grey-60'}
            >
                You don't have any notifications at the moment, but once you do
                they will live here.
            </span>
        </div>
    );
...
const ErrorActivityDrawer = () => {
    return (
        <div className="flex h-full w-full flex-col items-center justify-center p-4">
            ...
            <span
                className={'inter-base-regular mt-2 text-center text-grey-60'}
            >
                Something went wrong while trying to fetch your notifications -
                We will keep trying!
            </span>
