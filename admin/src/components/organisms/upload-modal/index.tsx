        ...
        <div className="relative">
            ...
            <div className="border-1 relative mt-6 flex items-center rounded-xl border">
                <div className="m-4">
                    <FileIcon
                        size={30}
                        fill={progress ? '#9CA3AF' : '#2DD4BF'}
                    />
                </div>

                <div className="my-6 flex-1">
                    <div className="text-small leading-5 text-grey-90">
                        {name}
                    </div>
        ...
        <Modal open handleClose={onClose}>
            <Modal.Body>
                <Modal.Content>
                    ...
                    <p className="mb-4 text-base text-grey-50">
                        {description1Text}
                    </p>
                    ...
                    <p className="mb-2 text-base text-grey-50">
                        {description2Text}
                    </p>
