    ...
    const filteringOptions = [
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    count: elements.filter(
                        (e) =>
                            e.entityType === 'user' && e.entity.role === 'admin'
                    ).length,
                    onClick: () =>
                        setShownElements(
                            elements.filter(
                ...
                },
                {
                    ...
                    count: elements.filter((e) => e.entityType === 'invite')
                        .length,
                    onClick: () =>
                        setShownElements(
                            elements.filter((e) => e.entityType === 'invite')
                        )
                }
            ]
        },
        {
            ...
            options: [
                ...
                {
                    title: 'Active',
                    count: elements.filter((e) => e.entityType === 'user')
                        .length,
                    onClick: () =>
                        setShownElements(
                            elements.filter((e) => e.entityType === 'user')
                        )
                },
                {
                    title: 'Pending',
    ...
    return (
        <div className="h-full w-full overflow-y-auto">
            ...
            >
                ...
                <Table.Body>
                    {shownElements.map((e) => e.tableElement)}
                </Table.Body>
            </Table>
            {selectedUser &&
                (deleteUser ? (
