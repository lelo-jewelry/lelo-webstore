...
const AmountAndCurrencyInput = ({
    ...
    return (
        <div className="flex w-full flex-col">
            ...
            <div className="rounded-rounded focus-within:shadow-focus-border">
                <div className="relative h-10 rounded-rounded bg-grey-5 shadow-border transition-colors focus-within:shadow-cta">
                    <NextSelect
                        customStyles={{
                            control:
                                'border-none absolute inset-0 bg-transparent focus-within:shadow-none !shadow-none focus-within:border-none pl-0',
                            inner_control:
                                '!max-w-[92px] border-r border-grey-20 pl-base'
                        }}
                        placeholder="USD"
                    ...
                    />
                    <div className="inter-base-regular absolute inset-y-0 left-[92px] right-0 flex h-10 items-center pl-xsmall pr-base">
                        <AmountField
                            ref={inputRef}
                            step={step}
                        ...
                        <div className="ml-2xsmall flex min-w-[16px] items-center">
                            <p className="w-full text-right text-grey-40">
                                {symbol_native}
                            </p>
                        </div>
                    </div>
