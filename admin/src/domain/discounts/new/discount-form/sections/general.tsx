    ...
    useEffect(() => {
        if (type === 'fixed' && regions) {
            ...
            if (Array.isArray(regions) && regions.length) {
                ...
                id = (regions as unknown as { label: string; value: string })
                    .value; // if you change from fixed to percentage, unselect and select a region, and then change back to fixed it is possible to make useForm set regions to an object instead of an array
            }
