                ...
                shipping_address:
                    type === 'replace'
                        ? {
                              ...
                              address_2:
                                  data.shipping_address.address_2 || undefined,
                              city: data.shipping_address.city,
                              country_code:
                                  data.shipping_address.country_code.value,
                              company:
                                  data.shipping_address.company || undefined,
                              first_name: data.shipping_address.first_name,
                              last_name: data.shipping_address.last_name,
                              phone: data.shipping_address.phone || undefined,
                              postal_code: data.shipping_address.postal_code,
                              province:
                                  data.shipping_address.province || undefined
                          }
                        : undefined,
                ...
                <form onSubmit={onSubmit} data-testid="register-claim-form">
                    <Modal.Content>
                        <div className="flex flex-col gap-y-xlarge">
                            ...
                            />
                            <ClaimTypeForm
                                form={nestedForm(form, 'claim_type')}
                            />
                            {watchedType === 'replace' && (
                                <>
                                    <ItemsToSendForm
