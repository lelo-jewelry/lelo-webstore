                        ...
                        {isSystemPayment && (
                            <div className="inter-small-regular mb-6 flex rounded-rounded bg-orange-5 p-4 text-orange-50">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    One or more of your payments is a system
                                    payment. Be aware, that captures and refunds
                                    are not handled by Medusa for such payments.
                                </div>
                            </div>
                        )}
