                        ...
                        <Accordion defaultValue={['general']} type="multiple">
                            ...
                            >
                                <p className="inter-base-regular text-grey-50">
                                    To start selling, all you need is a name and
                                    a price.
                                </p>
                                <div className="mt-xlarge flex flex-col gap-y-xlarge">
                                    ...
                                    />
                                    <DiscountableForm
                                        form={nestedForm(form, 'discounted')}
                                    />
                                </div>
                            </Accordion.Item>
                            ...
                            <Accordion.Item title="Variants" value="variants">
                                <p className="inter-base-regular text-grey-50">
                                    ...
                                    <br />
                                    Offer your customers different options for
                                    color, format, size, shape, etc.
                                </p>
                            ...
                            >
                                ...
                                <div className="my-xlarge">
                                    ...
                                    <DimensionsForm
                                        form={nestedForm(form, 'dimensions')}
                                    />
                                </div>
                                <div>
                                    <h3 className="inter-base-semibold mb-base">
                                    ...
                                    <CustomsForm
                                        form={nestedForm(form, 'customs')}
                                    />
                                </div>
                            </Accordion.Item>
                            <Accordion.Item title="Thumbnail" value="thumbnail">
                                <p className="inter-base-regular mb-large text-grey-50">
                                    Used to represent your product during
                                    checkout, social sharing and more.
                                </p>
                                <ThumbnailForm
                                    form={nestedForm(form, 'thumbnail')}
                                />
                            </Accordion.Item>
